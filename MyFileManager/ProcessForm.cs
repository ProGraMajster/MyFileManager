    ...
    public partial class ProcessForm : Form
    {
        ...
        private void StopProcess()
        {
            if(lvwProcess.SelectedItems.Count > 0)
            {
                ...
                {
                    MessageBox.Show("Nie można zamknąć tego procesu!", "Błąd", MessageBoxButtons.OK, MessageBoxIcon.Error);
                }
            }
            else
            {
                MessageBox.Show("Wybierz proces！", "Błąd", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
