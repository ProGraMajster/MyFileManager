...
namespace MyFileManager
{
    public partial class MainForm : Form
    {
        ...
        //Aktualnie wybrany węzeł drzewa (węzeł katalogu)
        private TreeNode curSelectedNode = null;

        //Czy przenieść pliki
        private bool isMove = false;

        //Ścieżka źródłowa pliku \ folderu do skopiowania i wklejenia
        private string[] copyFilesSourcePaths = new string[200];

        //Pierwszy węzeł ścieżki historycznej ścieżki dostępu użytkownika
        private DoublyLinkedListNode firstPathNode = new DoublyLinkedListNode();

        //Bieżący węzeł ścieżki
        ...
        {
            InitializeComponent();
            toolStripMenuItem1.Checked = Properties.Settings.Default.PoleWyborutsmiView;
            tsmiToolbar.Checked = Properties.Settings.Default.MainToolbar;
            tsmiStatusbar.Checked = Properties.Settings.Default.MainStatusbar;
            tsMain.Visible = !tsMain.Visible;
            ssFooter.Visible = !ssFooter.Visible;;

            MainForm.colorListViewHeader(ref lvwFiles, Properties.Settings.Default.DefaultBackColor, Properties.Settings.Default.DefaultForeColor);
        }
        ...
        {
            // Zainicjuj powiązane opcje „widoku”
            InitViewChecks();

            // Zainicjuj wyświetlanie interfejsu menedżera
            InitDisplay();

            columnHeader1.Width = Properties.Settings.Default.WcolumnHeader1;
            columnHeader2.Width = Properties.Settings.Default.WcolumnHeader2;
            columnHeader3.Width = Properties.Settings.Default.WcolumnHeader3;
            columnHeader4.Width = Properties.Settings.Default.WcolumnHeader4;
        ...
        {
            // Kiedy zmienia się rozmiar formularza, zmienia się również długość paska adresu
        ...
        private void tsbtnBack_Click(object sender, EventArgs e)
        {
            ...
            {
                //Przycisk Wstecz jest niedostępny
        ...
        {
            tscboSearch.Text = "szybkie wyszukiwanie";
        }
        ...
        private void tvwDirectory_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            {
                curFilePath = @"Ostatnio odwiedzone";
        ...
        private void InitDisplay()
        {
            ...
            TreeNode recentFilesNode = tvwDirectory.Nodes.Add("Ostatnio odwiedzone");
            recentFilesNode.Tag = "Ostatnio odwiedzone";
            ...
            foreach (DriveInfo info in driveInfos)
            {
                ...
                switch (info.DriveType)
                {
                    ...
                    case DriveType.Fixed:
                        ...
                        //显示的名称
                        driveNode = tvwDirectory.Nodes.Add("Dysk lokalny(" + info.Name.Split('\\')[0] + ")");
                    ...
                    case DriveType.CDRom:
                        ...
                        //显示的名称
                        driveNode = tvwDirectory.Nodes.Add("Napęd optyczny(" + info.Name.Split('\\')[0] + ")");
                    ...
                    case DriveType.Removable:
                        ...
                        //显示的名称
                        driveNode = tvwDirectory.Nodes.Add("Dysk wymienny(" + info.Name.Split('\\')[0] + ")");
        ...
        private void LoadChildNodes(TreeNode node)
        {
            try
            {
                ...
                if (node.Tag.ToString() == "Ostatnio odwiedzone")
                {
                    return;
                }
                else
        ...
        public void ShowFilesList(string path, bool isRecord)
        {
            ...
            if (path == "Ostatnio odwiedzone")
            {
                ...
                foreach (string file in recentFiles)
                {
                    if (File.Exists(file))
                    {
                        ...
                        item.SubItems.Add(fileInfo.Extension + "plik");
            ...
            //更新状态栏
            tsslblFilesNum.Text = lvwFiles.Items.Count + " Elementów";
        ...
        private void ShowAttributeForm()
        {
            ...
            if (lvwFiles.SelectedItems.Count == 0)
            {
                ...
                if (curFilePath == "Ostatnio odwiedzone")
                {
                    MessageBox.Show("Nie można wyświetlić właściwości bieżącej ścieżki！", "Błąd", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
        ...
        private void ShowPrivilegeForm()
        {
            ...
            if (lvwFiles.SelectedItems.Count == 0)
            {
                if (curFilePath == "Ostatnio odwiedzone")
                {
                    MessageBox.Show("Nie można wyświetlić zarządzania uprawnieniami dla bieżącej ścieżki！", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    return;
                }
        ...
        private void CreateFolder()
        {
            if (curFilePath == "Ostatnio odwiedzone")
            {
                MessageBox.Show("Nie można utworzyć nowego folderu w bieżącej ścieżce！", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
            ...
            {
                int num = 1;
                string path = Path.Combine(curFilePath, "Nowy folder");
                ...
                ListViewItem item = lvwFiles.Items.Add("Nowy folder" + (num == 1 ? "" : "(" + (num - 1) + ")"), IconsIndexes.Folder);
        ...
        private void CreateFile()
        {
            if (curFilePath == "Ostatnio odwiedzone")
            {
                MessageBox.Show("Nie można utworzyć nowego pliku w bieżącej ścieżce！", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void PasteFiles()
        {
            ...
            if (curFilePath == "Ostatnio odwiedzone")
            {
                MessageBox.Show("Nie można wkleić w bieżącej ścieżce！", "Błąd", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void DeleteFiles()
        {
            if (lvwFiles.SelectedItems.Count > 0)
            {
                DialogResult dialogResult = MessageBox.Show("Na pewno chcesz go usunąć？", "Potwierdź usunięcie", MessageBoxButtons.YesNo, MessageBoxIcon.Exclamation);
        ...
        private void SearchWithMultiThread(string path, string fileName)
        {
            ...
            //更新状态栏
            tsslblFilesNum.Text = 0 + " Elementów";
        ...
        private void opcjeProgramuToolStripMenuItem_Click(object sender, EventArgs e)
        {
        ...
        private void tsMain_BackColorChanged(object sender, EventArgs e)
        {
        ...
        {
            Properties.Settings.Default.MainFormSpliterDistance = splitContainer1.SplitterDistance;
        }
        ...
        private void lvwFiles_ColumnWidthChanging(object sender, ColumnWidthChangingEventArgs e)
        {
            if(e.ColumnIndex == 0)
            {
                Properties.Settings.Default.WcolumnHeader1 = columnHeader1.Width;
            }
            else if(e.ColumnIndex == 1)
            {
                Properties.Settings.Default.WcolumnHeader2 = columnHeader2.Width;
            }
            else if(e.ColumnIndex == 2)
            {
                Properties.Settings.Default.WcolumnHeader3 = columnHeader3.Width;
            }
            else if(e.ColumnIndex == 3)
            {
                Properties.Settings.Default.WcolumnHeader4 = columnHeader4.Width;
            }
        }
        ...
        {
            if(Properties.Settings.Default.MainDarkBool == true)
            {
                tsmiFile.ForeColor = Properties.Settings.Default.DefaultBackColor;
                tsmiFile.BackColor = Properties.Settings.Default.DefaultForeColor;
            }
            else
            {
                tsmiFile.ForeColor = Properties.Settings.Default.DefaultForeColor;
                tsmiFile.BackColor = Properties.Settings.Default.DefaultBackColor;
            }
        }
        ...
        private void tsmiEdit_DropDownOpening(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.MainDarkBool == true)
            {
                tsmiEdit.ForeColor = Properties.Settings.Default.DefaultBackColor;
                tsmiEdit.BackColor = Properties.Settings.Default.DefaultForeColor;
            }
            else
            {
                tsmiEdit.ForeColor = Properties.Settings.Default.DefaultForeColor;
                tsmiEdit.BackColor = Properties.Settings.Default.DefaultBackColor;
            }
        }
        ...
        private void tsmiView_DropDownOpening(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.MainDarkBool == true)
            {
                tsmiView.ForeColor = Properties.Settings.Default.DefaultBackColor;
                tsmiView.BackColor = Properties.Settings.Default.DefaultForeColor;
            }
            else
            {
                tsmiView.ForeColor = Properties.Settings.Default.DefaultForeColor;
                tsmiView.BackColor = Properties.Settings.Default.DefaultBackColor;
            }
        }
        ...
        private void tsmiTool_DropDownOpening(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.MainDarkBool == true)
            {
                tsmiTool.ForeColor = Properties.Settings.Default.DefaultBackColor;
                tsmiTool.BackColor = Properties.Settings.Default.DefaultForeColor;
            }
            else
            {
                tsmiTool.ForeColor = Properties.Settings.Default.DefaultForeColor;
                tsmiTool.BackColor = Properties.Settings.Default.DefaultBackColor;
            }
        }

        private void tsmiTool_DropDownClosed(object sender, EventArgs e)
        {
            tsmiTool.ForeColor = Properties.Settings.Default.DefaultForeColor;
            tsmiTool.BackColor = Properties.Settings.Default.DefaultBackColor;
        }

        private void tsmiHelp_DropDownOpening(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.MainDarkBool == true)
            {
                tsmiHelp.ForeColor = Properties.Settings.Default.DefaultBackColor;
                tsmiHelp.BackColor = Properties.Settings.Default.DefaultForeColor;
            }
            else
            {
                tsmiHelp.ForeColor = Properties.Settings.Default.DefaultForeColor;
                tsmiHelp.BackColor = Properties.Settings.Default.DefaultBackColor;
            }
        }

        private void tsmiHelp_DropDownClosed(object sender, EventArgs e)
        {
            tsmiHelp.ForeColor = Properties.Settings.Default.DefaultForeColor;
            tsmiHelp.BackColor = Properties.Settings.Default.DefaultBackColor;
        }
        ...
        private void tsmiFile_MouseEnter(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.MainDarkBool == true)
            {
                tsmiFile.ForeColor = Properties.Settings.Default.DefaultBackColor;
        ...
        private void tsmiFile_MouseLeave(object sender, EventArgs e)
        {
            tsmiFile.ForeColor = Properties.Settings.Default.DefaultForeColor;
            tsmiFile.BackColor = Properties.Settings.Default.DefaultBackColor;
        }

        private void tsmiEdit_MouseEnter(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.MainDarkBool == true)
            {
                tsmiEdit.ForeColor = Properties.Settings.Default.DefaultBackColor;
        ...
        private void tsmiEdit_MouseLeave(object sender, EventArgs e)
        {
            tsmiEdit.ForeColor = Properties.Settings.Default.DefaultForeColor;
            tsmiEdit.BackColor = Properties.Settings.Default.DefaultBackColor;
        }

        private void tsmiView_MouseEnter(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.MainDarkBool == true)
            {
                tsmiView.ForeColor = Properties.Settings.Default.DefaultBackColor;
        ...
        private void tsmiView_MouseLeave(object sender, EventArgs e)
        {
            tsmiView.ForeColor = Properties.Settings.Default.DefaultForeColor;
            tsmiView.BackColor = Properties.Settings.Default.DefaultBackColor;
        }

        private void tsmiTool_MouseEnter(object sender, EventArgs e)
        {
            if (Properties.Settings.Default.MainDarkBool == true)
            {
                tsmiTool.ForeColor = Properties.Settings.Default.DefaultBackColor;
        ...
        private void tsmiTool_MouseLeave(object sender, EventArgs e)
        {
            tsmiTool.ForeColor = Properties.Settings.Default.DefaultForeColor;
            tsmiTool.BackColor = Properties.Settings.Default.DefaultBackColor;
        }
        ...
        private void tsmiHelp_MouseLeave(object sender, EventArgs e)
        {
            tsmiHelp.ForeColor = Properties.Settings.Default.DefaultForeColor;
            tsmiHelp.BackColor = Properties.Settings.Default.DefaultBackColor;
        }
        ...
        {
            ShowFilesList(args[1], false);
            timerP.Stop();
        }

        private void tscboSearch_Click(object sender, EventArgs e)
        {
        ...
        {
            NewShortcut newShortcut = new NewShortcut(lvwFiles.SelectedItems[0].Tag.ToString());
            newShortcut.Show();
        }
        ...
        private void toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            {
                Properties.Settings.Default.PoleWyborutsmiView = true;
                lvwFiles.CheckBoxes = true;
            }
            else
            {
                Properties.Settings.Default.PoleWyborutsmiView = false;
