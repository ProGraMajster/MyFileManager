...
namespace MyFileManager
{
    public partial class PrivilegeForm : Form
    {
        ...
        private List<string> privilegeList = new List<string> { "Pełna kontrola", "Modyfikacja", "Odczyt i wykonywanie", "Wyświetlanie zawartości folderu", "Odczyt", "Zapis" };
        ...
        private void lvwPrivilege_ItemChecked(object sender, ItemCheckedEventArgs e)
        {
            ...
            if (!isUpdateCheckBoxes)
            {
                if (e.Item.Checked)
                {
                    ...
                    if (File.Exists(fileName) && e.Item.Text == "Wyświetlanie zawartości folderu")
                    {
        ...
        private void SetPrivilegeListChecked(string privilege)
        {
            switch (privilege)
            {
                ...
                case "Modify":
                    ...
                    foreach (ListViewItem item in lvwPrivilege.Items)
                    {
                        if (item.Text == "Modyfikacja" || item.Text == "Odczyt i wykonywanie" || item.Text == "Odczyt" || item.Text == "Zapis")
                        {
                            item.Checked = true;
                        }
                    }
                ...
                case "ReadAndExecute":
                    ...
                    foreach (ListViewItem item in lvwPrivilege.Items)
                    {
                        if (item.Text == "Odczyt i wykonywanie" || item.Text == "Odczyt")
                        {
                            item.Checked = true;
                        }
                    }
                ...
                case "ListDirectory":
                    ...
                    foreach (ListViewItem item in lvwPrivilege.Items)
                    {
                        if (item.Text == "Wyświetlanie zawartości folderu")
                        {
                            item.Checked = true;
                        }
                    }
        ...
        private void SetPrivilegeListUnChecked(string privilege)
        {
            switch (privilege)
            {
                ...
                case "Modify":
                    ...
                    foreach (ListViewItem item in lvwPrivilege.Items)
                    {
                        if (item.Text == "Modyfikacja" || item.Text == "Odczyt i wykonywamie" || item.Text == "Odczyt" || item.Text == "Zapis")
                        {
                            item.Checked = false;
                        }
                    }
                ...
                case "ReadAndExecute":
                    ...
                    foreach (ListViewItem item in lvwPrivilege.Items)
                    {
                        if (item.Text == "Odczyt i wykonywamie" || item.Text == "Odczyt")
                        {
                            item.Checked = false;
                        }
                    }
        ...
        private void ShowPrivilegeList()
        {
            ...
            lblPrivilege.Text = lvwGroupOrUserName.Items[curSelected].Text + " pozwolenie：";
